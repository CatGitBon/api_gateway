...
const (
	APIGateway_Authenticate_FullMethodName = "/api_gateway.APIGateway/Authenticate"
)
...
//
// Сервис API api_gateway, определяет все операции доступные для клиента
...
func (c *aPIGatewayClient) Authenticate(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
	err := c.cc.Invoke(ctx, APIGateway_Authenticate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAPIGatewayServer) Authenticate(context.Context, *AuthRequest) (*AuthResponse, error) {
...
func _APIGateway_Authenticate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(APIGatewayServer).Authenticate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: APIGateway_Authenticate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(APIGatewayServer).Authenticate(ctx, req.(*AuthRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _APIGateway_Authenticate_Handler,
		},
	},
